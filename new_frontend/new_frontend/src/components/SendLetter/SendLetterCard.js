...
const useStyles = makeStyles((theme) => ({
  ...
  function SendLetterCard({props}) {
            ...
            <div className = "RLC_Modal">
                <div className="RLC_info">
                    ...
                    <div className="RLC_modalButton" >
                        <Button  onClick={back} className="RLC_modalButton2" variant="contained" color="secondary">
                            받은 편지 보기
                        </Button>
                    </div>
                </div>
    ...
    return(
        <>
            <div className ="SendLetterCard" onClick={handleOpen} onMouseOver={onMouseOver} onMouseLeave={onMouseLeave}>
