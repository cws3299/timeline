...
import './AnswerLetterContent.css'
...
function AnswerLetterContent({props}) {
    ...
    const onClick = async () => {
        ...
        // 서버의 upload API 호출
        const res = await axios.post(`${url}/mailbox/reply?lidx=${props}`, formData, token)
        .then(()=>{
          alert("성공")
        }).catch(()=>{
    ...
    return(
        <div className="AnswerLetterContent">
...
export default AnswerLetterContent;